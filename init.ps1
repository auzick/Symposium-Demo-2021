...
try {
    ...
    & $mkcert -install
    & $mkcert "*.basicnextjsdemo.localhost"
...
Add-HostsEntry "cm.basicnextjsdemo.localhost"
Add-HostsEntry "cd.basicnextjsdemo.localhost"
Add-HostsEntry "id.basicnextjsdemo.localhost"
Add-HostsEntry "www.basicnextjsdemo.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.basicnextjsdemo.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.basicnextjsdemo.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.basicnextjsdemo.localhost"
